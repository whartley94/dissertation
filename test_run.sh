...
python -u train.py --name ClusterTest4 --sample_p 1.0 --niter 2 --niter_decay 0 --classification --phase train --gpu_ids 0,1 --display_id -1 --data_dir dest_path --checkpoints_dir cpoint_path --print_freq 1 --display_freq 1 --invisible_network --save_npy --save_mpl > pyout.out
echo "Python ended"
