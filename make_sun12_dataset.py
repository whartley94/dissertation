...
trn_small_path_x = os.path.join(opt.out_path, 'train_small')
if os.path.isdir(trn_small_path_x):
	shutil.rmtree(trn_small_path_x)
...
trn_path_x = os.path.join(opt.out_path, 'train')
if os.path.isdir(trn_path_x):
	shutil.rmtree(trn_path_x)
