...
base_call = f"python train.py --sample_p .125 --niter_decay 0 --display_id -1 " \
    ...
    f"--batch_size 120 --gpu_ids 0,1,2,3,4,5,6,7 --lr 0.000001 --weighted_mask --save_optimizer --spread_mask"
...
output_file = open("sp_experiments_vec.txt", "w")
output_file2 = open("sp_portions_vec.txt", "w")
