...
# Logging information
# =====================
MODEL_NAME=siggraph_caffemodel
...
python test_sweep.py --gpu_ids 0 --name ${MODEL_NAME} --data_dir ${sorted_path} --checkpoints_dir ${cpoint_dir} --resources_dir ${resource_path}
echo "Python ended"
